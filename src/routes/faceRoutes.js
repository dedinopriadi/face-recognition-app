...
const { enrollValidationRules, recognizeValidationRules, validate } = require('../middleware/validator');
...
const recognizeValidation = [
  // No body validation needed for recognition, only file upload
];
